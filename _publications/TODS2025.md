...
permalink: /publication/TODS2025
excerpt: '**Qichen Wang** and Ke Yi.'
date: 2025-10-01
venue: 'ACM Transactions on Database Systems (<b>TODS</b>)'
paperurl: 'https://doi.org/10.1145/3769424'
pubtype: 'journal'
---
...
The experiment scripts have obtained the ACM Reproducibility certification! You can reproduce the experiment results and all figures by using our [experiment scripts](https://github.com/hkustDB/SparkCQC)!  Thanks to Binyang Dai for his work to pass the test.

Our [**demo**](/publication/SIGMOD23Demo) system for CQC has been accepted by SIGMOD 2023.  Thanks to Binyang for his hard work. 
